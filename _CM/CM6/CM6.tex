...
\begin{frame}{Consignes générales}
	\begin{itemize}
		...
		\end{itemize} 
		\item \underline{type de présentation} : \bolderblue{orale} (avec \bolderblue{supports})
		\begin{itemize}
			...
			\end{itemize}
			\item déposer la présentation sur \href{https://moodle-lettres-24.sorbonne-universite.fr/mod/assign/view.php?id=102291}{Moodle}
		\end{itemize}
